const hiddenLis = Array.from(document.querySelectorAll(".slide-content__nav > li"));
const hiddenLiSecond = Array.from(document.querySelectorAll(".slide-content__nav > li:first-child"));
...
window.onscroll = function () {
  window.scrollY >= 650 ? scrollTo.classList.add("popup") : scrollTo.classList.remove("popup");
}
